        ...
        <div className="flex-1 lg:overflow-y-auto pr-2 space-y-6 pb-24 lg:pb-0">
          {activeSection === 0 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="mb-6">
                <h3 className="text-lg lg:text-xl font-medium text-slate-900 dark:text-white/90">Curriculum Requirements</h3>
          ...
          {activeSection > 0 && (
            <div className="p-10 lg:p-20 flex flex-col items-center justify-center text-center opacity-40">
