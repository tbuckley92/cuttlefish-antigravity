...
const OSATSForm: React.FC<OSATSFormProps> = ({ 
  ...
  const criteria = [
    ...
    "Use of procedure-specific equipment (e.g. phaco machine).",
      ...
      <div className="hidden lg:flex lg:col-span-4 flex-col gap-6 overflow-y-auto pr-2">
        ...
        <GlassCard className="p-8">
          ...
          <div className="space-y-6">
            ...
            <MetadataField label="Level of Training">
        ...
        <div className="flex-1 lg:overflow-y-auto pr-2 space-y-6 pb-24 lg:pb-0">
          {activeSection === 0 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              <h3 className="text-lg lg:text-xl font-medium text-slate-900 dark:text-white/90 mb-6">Details of OSATS</h3>
              <GlassCard className="p-4 lg:p-6 space-y-6">
                ...
                <RadioGroup disabled={isLocked} label="Overall difficulty of case" options={["Simple", "Intermediate", "Difficult"]} value={difficulty} onChange={setSetting} />
